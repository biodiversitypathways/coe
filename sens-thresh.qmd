...
#| include: true
#| fig-align: center
#| fig-cap: Monitoring locations with a 400 m buffer
...
leaflet() %>%
  ...
  addPolygons(
    ...
    popup = ~paste("Random Location:", coe_2025_random_buffered$location),
    color = "green",
    fillOpacity = 0.3
  ) %>%
