...
<div style="display: flex; justify-content: space-around; padding: 20px;">
  <a href="https://sensr.ca" target="_blank" style="text-decoration: none;">
    <img src="https://via.placeholder.com/50?text=SENSR" alt="SENSR" style="width: 50px; height: 50px; border-radius: 50%;"/>
  </a>
  <a href="https://biodiversitypathways.ca" target="_blank" style="text-decoration: none;">
    <img src="https://via.placeholder.com/50?text=BP" alt="Biodiversity Pathways" style="width: 50px; height: 50px; border-radius: 50%;"/>
  </a>
  <a href="https://abmi.ca" target="_blank" style="text-decoration: none;">
    <img src="https://via.placeholder.com/50?text=ABMI" alt="ABMI" style="width: 50px; height: 50px; border-radius: 50%;"/>
  </a>
</div>

dunluce tree stand
st albert trail 136 st
rampart 
crystallina nera
